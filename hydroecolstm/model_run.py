...
def run_train(config):
    ...
    model = trainer.train(x_train_scale, y_train_scale, 
                          x_valid_scale, y_valid_scale)
    ...
    # Save model and data
    #torch.save(model.state_dict(), Path(config["output_directory"][0], 
    #                                    "best_model.pt") )
    #torch.save(data, Path(config["output_directory"][0], 
    #                                    "data.pt"))
